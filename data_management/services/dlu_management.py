    ...
    def insert_redcap_participant(self, redcap_participant):
        if self.get_redcap_participant_count(redcap_participant["redcap_id"]) == 0:
            ...
            self.db.insert_data(
                ...
                + "redcap_id, redcap_np_sex, redcap_age_binned, redcap_enrollment_category, "
                + "redcap_protocol, redcap_sample_type, redcap_tissue_source, redcap_clinical_data,"
                  ...
                  "redcap_exp_diabetes_duration, redcap_exp_ht_duration, redcap_exp_egfr_bl_cat, redcap_adj_primary_category, redcap_exp_egfr_bl)"
